...
public abstract class BOptionPane {
	 ...
	 * @return senha
	 */
	public static char[] showPasswordDialog(JWindow window, String title, String message) {
	 ...
	 */
	public static int showConfirmDialog(JWindow window, String title, String message, int time) {
	...
	private static class ConfirmFrame extends JDialog {
		 ...
		 * @param time
		 */
		public ConfirmFrame(JWindow window, String title, String message, final int time) {
			super(window);
			this.setModal(true);
			this.setTitle(title);
			this.setLayout(new BorderLayout(10, 0));
