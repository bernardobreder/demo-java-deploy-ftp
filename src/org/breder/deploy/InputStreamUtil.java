...
public class InputStreamUtil {
	 ...
	 * @throws IOException
	 */
	public static void extractZip(ZipInputStream input, File dir) throws IOException {
		if (dir.exists() && !dir.isDirectory()) {
			throw new IllegalArgumentException("dir is not a folder : " + dir.getAbsolutePath());
		}
		for (;;) {
	...
	public static InputStream getResource(String resource) {
		...
		if (input == null) {
			input = InputStreamUtil.class.getClassLoader().getResourceAsStream(resource);
		}
		return input;
	}
